...
- **Регионы** — создание, редактирование настроек слотов (время, горизонт календаря, платные слоты, цена, лимит публикаций), соцсети/каналы, включение/отключение региона. Изменения сохраняются мгновенно.
