...
class UserModel(BaseModel, CreatedAtMixin, UpdatedAtMixin):
    ...
    balance: Mapped[Decimal] = mapped_column(
        NUMERIC(12, 2), default=0.00, server_default="0.00"
    )
    is_blocked: Mapped[bool] = mapped_column(Boolean, default=False)
    is_payment_blocked: Mapped[bool] = mapped_column(
    ...
    def to_entity(self) -> "User":
        return User(
            ...
            is_payment_blocked=self.is_payment_blocked,
    ...
    def _update_model(self, user: "User") -> None:
        ...
        self.is_payment_blocked = user.is_payment_blocked
