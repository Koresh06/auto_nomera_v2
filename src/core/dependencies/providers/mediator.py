...
from src.application.use_cases.ad.ensure_ad_image_ref import EnsureAdImageRefRequest, EnsureAdImageRefUseCase
...
from src.application.use_cases.publication.publish_publication import PublishPublicationRequest, PublishPublicationUseCase
from src.application.use_cases.publication_service.add_service_to_publication import AddServiceToPublicationRequest, AddServiceToPublicationUseCase
...
from src.application.use_cases.publication.confirm_paid_slot_and_schedule_publication import ConfirmPaidSlotAndSchedulePublicationRequest, ConfirmPaidSlotAndSchedulePublicationUseCase
...
class MediatorProvider(Provider):
    ...
    def mediator(
        ...
        mediator.register(SelectSlotForPublicationRequest, select_slot_for_publication_use_case)
        mediator.register(AddServiceToPublicationRequest, add_service_to_publication_use_case)
        mediator.register(PriorityPublishPublicationRequest, priority_publish_publication_use_case)
        ...
        mediator.register(CreatePublicationFromAdRequest, create_publication_from_ad_use_case)
